<template>
  <div class="popup" :class="delayOpen?'showing':''" @click="close" @contextmenu="close" @keydown.esc="close" tabindex="0">
    <div class="inner-popup" @click="stopClose" @contextmenu="close">
      <Card  :cardName="this.cardName" :cardProps="cardProps" :unmovable="true" :hidden="cardHidden" :showcaseCard="true" />
      <div class="card-resume">
        ...
        <div class="description">
          ...
          <div class="separator"> <img src="/misc/separator.png" Width="80%"/> </div>
          <div class="abilities">
    ...
    .inner-popup{
      ...
      .card-resume{
        ...
        .header{
          ...
          border-style: solid;
          border-image-source: url(/misc/title-top_.png);
        ...
        .description{
          ...
          width:100%;
          max-height: 475px;
          background-image:  url(/misc/description_.png);
          background-size: 100%;
          background-repeat: no-repeat, repeat-y;
